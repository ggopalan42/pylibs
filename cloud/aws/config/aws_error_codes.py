...
AWS_IAM_POLICY_ALREADY_EXISTS = 3
AWS_IAM_POLICY_DOES_NOT_EXIST = 4
...
AWS_ERROR_MESSAGES = {
    ...
    AWS_IAM_POLICY_ALREADY_EXISTS: 'AWS IAM Policy Already Exists',
    AWS_IAM_POLICY_DOES_NOT_EXIST: 'AWS IAM Policy Does Not Exist',
}
